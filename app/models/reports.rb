...
class Reports
  ...
  def new_women_registered
    ...
    Encounter.find(:all, :group => ["patient_id"],  
      ...
      :conditions => ["patient_id IN (?) AND encounter_datetime <= ?", 
        @cohortpatients, @end_date]).collect{|e| 
      [e.patient_id, e.encounter_id]}.delete_if{|x, y| y > 1}.collect{|x, y| x}.uniq
...
=end    
    ...
    Encounter.find(:all, :group => ["patient_id"],  
      ...
      :conditions => ["patient_id IN (?) AND encounter_datetime <= ?", 
        @cohortpatients, @end_date]).collect{|e| 
      [e.patient_id, e.encounter_id]}.delete_if{|x, y| y != 2}.collect{|x, y| x}.uniq
...
=end    
    ...
    Encounter.find(:all, :group => ["patient_id"],  
      ...
      :conditions => ["patient_id IN (?) AND encounter_datetime <= ?", 
        @cohortpatients, @end_date]).collect{|e| 
      [e.patient_id, e.encounter_id]}.delete_if{|x, y| y != 3}.collect{|x, y| x}.uniq
...
=end    
    ...
    Encounter.find(:all, :group => ["patient_id"],  
      ...
      :conditions => ["patient_id IN (?) AND encounter_datetime <= ?", 
        @cohortpatients, @end_date]).collect{|e| 
      [e.patient_id, e.encounter_id]}.delete_if{|x, y| y != 4}.collect{|x, y| x}.uniq
...
=end    
    ...
    Encounter.find(:all, :group => ["patient_id"],  
      ...
      :conditions => ["patient_id IN (?) AND encounter_datetime <= ?", 
        @cohortpatients, @end_date]).collect{|e| 
      [e.patient_id, e.encounter_id]}.delete_if{|x, y| y < 5}.collect{|x, y| x}.uniq
