...
"localhost:3000/encounters/new/art_initial?action=show&controller=encounter_types&encounter_type=ART+initial&id=show&patient_id=", 
"Link to ART system from ANC system", (SELECT UUID()));
INSERT INTO `global_property` (property, property_value, description, uuid) VALUES ("art_link", 
