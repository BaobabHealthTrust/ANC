class PatientBean
 ...
 attr_accessor :date, :weight, :height, :bmi, :outcome, :reg, :s_eff, :sk , :pn, :hp, :pills, :gave,
   ...
   :last_name, :cell_phone_number, :office_phone_number, :home_phone_number, :old_identification_number, :birthdate, :race, :citizenship
 ...
 attr_accessor :patient_id,:arv_number, :national_id ,:name ,:age ,:sex, :init_wt, :init_ht ,
   ...
   :first_positive_hiv_test_type, :months_on_art, :current_app_national_id, :state_province, :home_village, :current_district
